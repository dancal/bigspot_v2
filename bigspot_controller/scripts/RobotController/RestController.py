...
class RestController(object):
    def __init__(self, body, legs):
        ...
        #self.pid_controller     = PID_controller(0.5, 1.5, 0.1)
    ...
    def updateStateCommand(self, msg, state, command, motion):
        ...
        # local body position
        state.body_local_position[0] = msg.axes[7] * 0.2
        state.body_local_position[1] = msg.axes[6] * 0.4
        state.body_local_position[2] = msg.axes[1] * 0.4
    ...
    def step(self, state, command):
        ...
        if self.use_imu:
            ...
            print("self.use_imu = ", self.use_imu, ", roll_compensation = ", roll_compensation, ", pitch_compensation = ", pitch_compensation)
